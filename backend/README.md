...
## Project Structure
    ...
    ├── testapiautosetting_111043  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_111043`
...
2. Clone this repo and `cd testapiautosetting_111043`
